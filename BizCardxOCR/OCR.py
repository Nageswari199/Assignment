...
def setting_bg():
    st.markdown(f""" <style>.stApp {{
                        background: url("https://cutewallpaper.org/22x/5nxf08vkc/3039317996.jpg");
...
if selected == "Upload & Extract":
    st.markdown("### Uploading  a Business Card")
    ...
    if uploaded_card is not None:
        ...
        with col2:
            ...
            with st.spinner("Please wait processing image..."):
                ...
                st.pyplot(img_preview(image,res))  
        ...
        # CONVERTING IMAGE TO BINARY TO UPLOAD FOR SQL DATABASE
...
if selected == "Modify":
    ...
    try:
        with column1:
            ...
            # DISPLAYING ALL THE  REALTED INFORMATIONS
            ...
            if st.button("Commit changes to DB"):
                # Updating  the realted  information for the selected business card in the  respective database
        ...
        with column2:
            ...
            if st.button("Yes Delete Business Card"):
                ...
                mydb.commit()
                st.success("Business card related information deleted from database.")
    except:
    ...
    if st.button("View updated data"):
        ...
        updated_dataframe = pd.DataFrame(mycursor.fetchall(),columns=["Company_Name","Card_Holder","Designation","Mobile_Number","Email","Website","Area","City","State","Pin_Code"])
