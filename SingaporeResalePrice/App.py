...
data = pd.read_csv('venv/Scripts/mrt_sataion.csv')
...
if selected == "Predictions":
    ...
    st.markdown("### :pink[Predicting Resale Price]")
    ...
    try:
        with st.form("form1"):
            ...
            if submit_button is not None:
                with open(r"venv/Scripts/model.pkl", 'rb') as file:
                    loaded_model = pickle.load(file)
                with open(r'venv/Scripts/scaler.pkl', 'rb') as f:
